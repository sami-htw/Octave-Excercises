...
disp("Aufgabe 1)");
x_i = [ 1.3, 2.2, 2.9, 3.1, 4.5, 5.7, 7.1, 8.0, 8.7, 8.9, 9.3, 9.9 ]'; % transponiert spaltenvektor
y_i = [ 1.3, 1.0, 0.85, 0.80, 0.33, 0, -0.4, -0.7, -0.9, -1.0, -1.1, -1.2 ]'; % transponiert spaltenvektor
